...
class Bid(models.Model):
    ...
    tot_bid_size = models.DecimalField(
        max_digits=12, decimal_places=0, blank=True, null=True
    )
    tot_ask_size = models.DecimalField(
        max_digits=12, decimal_places=0, blank=True, null=True
    )
    tot_bid_count = models.DecimalField(
        max_digits=12, decimal_places=0, blank=True, null=True
    )
    tot_ask_count = models.DecimalField(
        max_digits=12, decimal_places=0, blank=True, null=True
    )
...
class ClosingPrice(models.Model):
    ...
    def __str__(self):
        return (
            f"ClosingPrice({self.busi_date}|{self.symbol}|{self.last}|{self.timestamp})"
        )
...
class Master(models.Model):
    ...
    prev_volume = models.DecimalField(
        max_digits=12, decimal_places=0, blank=True, null=True
    )
...
class Quote(models.Model):
    ...
    exec_volume = models.DecimalField(
        max_digits=10, decimal_places=0, blank=True, null=True
    )
    volume = models.DecimalField(max_digits=12, decimal_places=0, blank=True, null=True)
    amount = models.DecimalField(max_digits=14, decimal_places=0, blank=True, null=True)
