...
class AcceptMultiplePermissionMixin(
    AcceptMultipleOrPermissionMixin, AcceptObjectOrPermissionMixin
):
    pass
...
class ProtectedForeignKeyDeleteMixin:
    def destroy(self, request, *args, **kwargs):
        ...
        try:
            ...
            msg[
                "message"
            ] = "One of the following fields prevent deleting this instance: {}".format(
